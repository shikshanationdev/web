    ...
    <div className="max-w-6xl mx-auto px-4 py-12">
      <div className="max-w-none">
        ...
        <section className="mb-8">
          ...
          <p className="mb-2"><strong>Personal Information:</strong> Name, email address, phone number, age, and account details when you register.</p>
          <p className="mb-2"><strong>Payment Information:</strong> Billing details when you purchase courses (processed securely via third-party payment gateways).</p>
          <p className="mb-2"><strong>Usage Data:</strong> Information about how you use our website/app, including pages visited, time spent, and activities.</p>
          <p className="mb-2"><strong>Device Information:</strong> IP address, browser type, device details, and cookies for security and analytics.</p>
        </section>
        ...
        <section className="mb-8">
          ...
          <p className="mb-2"><strong>Service Providers:</strong> Payment gateways, hosting providers, and technical support partners.</p>
          <p className="mb-2"><strong>Legal Authorities:</strong> When required by law or to protect our rights.</p>
          <p className="mb-2"><strong>Affiliates/Partners:</strong> Only if you opt in for promotional or collaborative content.</p>
        </section>
        ...
        <section className="mb-8">
          ...
          <p>We recommend safeguarding your login credentials.</p>
        </section>
